(function(){
  ...
  var Game = {
    ...
    setFood : function() {
      ...
      var newPos = empty[Math.floor(Math.random()*(empty.length))];
  ...
  const STEP_MS = 100; // snake moves every 100ms = 10 steps/sec
  let lastTime = 0;
  let accumulator = 0;
  ...
  function update() {
    ...
    switch (Snake.direction) {
      case Util.LEFT:  nx--; break;
      case Util.UP:    ny--; break;
      case Util.RIGHT: nx++; break;
      case Util.DOWN:  ny++; break;
    }
